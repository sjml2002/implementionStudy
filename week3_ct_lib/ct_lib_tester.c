...
const char* str_case[TESTCASE + 1] = {"knet implemention study",
...
int main() {
    ...
    if (flag) printf("===>>> ct_putchar success!!!\n");
    ...
    if (flag) printf("===>>> ct_puts success!!!\n");
    ...
    if (flag) printf("===>>> ct_atoi success!!!\n");
    ...
    if (flag) printf("===>>> ct_strlen success!!!\n");
    ...
    printf("\n");
    if (flag) printf("===>>> ct_putnum success!!!\n");
    ...
    printf("\n");
    if (flag) printf("===>>> ct_substr success!!!\n");
